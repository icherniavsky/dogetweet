...
Additionally, each user must have tweeter account for <code>rtweet</code> to work. 
...
the function <code>stream_tweets</code> that this package relies on <
code>rtweet</code> which has some restrictions. More information can be found 
